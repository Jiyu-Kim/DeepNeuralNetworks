...
"""
#lesnet 
#best_valid_acc: 0.982, best_hyper_params: [30, 0.01, 0.0001, 100] 
#(num_epochs, learning_rate, reg_lambda, batch_size)
num_epochs_list = [10, 15, 20, 25, 30]
learning_rate_list = [0.01, 0.001, 0.0001]
reg_lambda_list = [0.01, 0.001, 0.0001]
batch_size_list = [100]
num_search = 30
"""
"""
#alexnet
#best_valid_acc: 0.982, best_hyper_params: [15, 0.0001, 0.0001, 100] 
#(num_epochs, learning_rate, reg_lambda, batch_size)
