...
class AlexNet(nn.Module):
    def __init__(self, input_channel, output_dim, learning_rate, reg_lambda, device):
        ...
        self.Conv_layers = nn.Sequential(self.CONV1, nn.ReLU(), self.POOL1, self.CONV2, nn.ReLU(), self.POOL2, self.CONV3, nn.ReLU(), self.CONV4, nn.ReLU(), self.CONV5, nn.ReLU(), self.POOL3)
