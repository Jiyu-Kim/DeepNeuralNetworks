...
#Add layers - last trial
model.add_layer('FC-1', FCLayer(784, 514))
model.add_layer('ReLU1',ReLU())
model.add_layer('FC-2', FCLayer(514, 256))
model.add_layer('ReLU2',ReLU())
model.add_layer('FC-3', FCLayer(256, 128))
model.add_layer('ReLU3',ReLU())
model.add_layer('FC-4', FCLayer(128, 64))
model.add_layer('ReLU4',ReLU())
model.add_layer('FC-5', FCLayer(64, 10))
model.add_layer('Softmax Layer', SoftmaxLayer())
